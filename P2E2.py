...
#Devuelve una lista con los elementos más frecuentes, en forma de tuplas (elemento, frecuencia).
palabra_frecuente, frecuencia = contador.most_common(1)[0]

print(f'Palabra más frecuente: "{palabra_frecuente}" con {frecuencia} apariciones')
